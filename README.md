...
- Для создания и запуска контейнеров используется команда docker-compose up. Для запуска и остановки контейнеров используется команда docker-compose start/stop. Для запуска сервера PHP используется команда docker-compose exec app php -S app:8080 -t /var/www/app/public/;
